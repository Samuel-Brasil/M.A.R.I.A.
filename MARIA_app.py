...
# Inicializa todas as agressões graves como 0
a_graves_features = [
    'a_graves_Afogamento', 'a_graves_Enforcamento', 'a_graves_Facada',
    'a_graves_nenhuma', 'a_graves_Paulada', 'a_graves_Queimadura',
...
# Inicializa todas as outras agressões como 0
agressoes_features = [
    'agressoes_Chutes', 'agressoes_Empurrões', 'agressoes_nenhuma',
...
if "Nenhuma das agressões acima" in outros_agressoes:
    input_data['agressoes_nenhuma'] = 1
else:
